...
export const INDUSTRY_REGISTRY: Record<string, IndustryConfig> = {
  ...
  'metal-fabrication': {
    ...
    description: 'Custom metal fabrication for industrial components',
    pricingMode: PricingMode.HYBRID,
    icon: 'M6.5 15a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1H7a.5.5 0 0 1-.5-.5zm0-2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1H7a.5.5 0 0 1-.5-.5zm0-2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1H7a.5.5 0 0 1-.5-.5zm0-2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1H7a.5.5 0 0 1-.5-.5z',
    basePrice: 35,
    formFields: [
      {
        id: 'material',
      ...
      },
      {
        ...
        defaultValue: 'low',
        options: [
          { id: 'low', label: 'Low - Simple structures' },
          { id: 'medium', label: 'Medium - Multiple processes' },
          { id: 'high', label: 'High - Complex assembly, precision required' },
        ],
      },
      {
        id: 'deadline',
    ...
    materials: [
      { id: 'steel', name: 'Steel', rate: 1.0 },
      { id: 'stainless-steel', name: 'Stainless Steel', rate: 1.8 },
      { id: 'aluminum', name: 'Aluminum', rate: 1.2 },
      { id: 'copper', name: 'Copper', rate: 2.5 },
      { id: 'brass', name: 'Brass', rate: 2.2 },
    ],
    complexityLevels: STANDARD_COMPLEXITY_LEVELS,
    pricingModel: 'metal_fabrication_predict',
    fallbackCalcFunction: 'calculateMetalFabricationQuote',
  },
    ...
    formFields: [
      {
        ...
        defaultValue: 'pcba',
        options: [
          { id: 'pcba', label: 'PCBA (PCB Assembly)' },
          { id: 'cable-harness', label: 'Cable Harness Assembly' },
          { id: 'box-build', label: 'Box Build Assembly' },
        ],
      },
      {
        id: 'quantity',
      ...
      },
      {
        ...
        defaultValue: 'smt',
        options: [
          { id: 'smt', label: 'SMT (Surface Mount)' },
          { id: 'tht', label: 'THT (Through Hole)' },
          { id: 'mixed', label: 'Mixed Technology' },
        ],
      },
      {
        id: 'testingRequired',
      ...
      },
      {
        ...
        defaultValue: 'standard',
        options: [
          { id: 'standard', label: 'Standard (15 days)' },
          { id: 'expedited', label: 'Expedited (8 days)' },
          { id: 'rush', label: 'Rush (4 days)' },
        ],
      },
      {
        id: 'complexity',
        ...
        defaultValue: 'medium',
        options: [
          { id: 'low', label: 'Low - Simple assembly, few components' },
          { id: 'medium', label: 'Medium - Standard complexity' },
          { id: 'high', label: 'High - Complex, fine-pitch, BGAs' },
        ],
      },
    ],
    materials: [
      { id: 'fr4', name: 'FR-4 Standard', rate: 1.0 },
      { id: 'fr4-high-tg', name: 'FR-4 High-Tg', rate: 1.5 },
      { id: 'ceramic', name: 'Ceramic', rate: 3.0 },
      { id: 'aluminum', name: 'Aluminum PCB', rate: 2.0 },
      { id: 'flexible', name: 'Flexible PCB', rate: 2.5 },
    ],
    complexityLevels: STANDARD_COMPLEXITY_LEVELS,
    pricingModel: 'electronics_assembly_predict',
    fallbackCalcFunction: 'calculateElectronicsAssemblyQuote',
  },
};
