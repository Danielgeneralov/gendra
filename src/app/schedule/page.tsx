...
export default function SchedulePage() {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
      ...
      <h1 className="text-3xl font-bold text-slate-900 mb-2">Dynamic Scheduling</h1>
      ...
      <div className="mt-12 p-6 bg-white rounded-lg shadow-sm border border-slate-200 max-w-md w-full">
        <h2 className="text-lg font-medium text-slate-900 mb-4">Gendra Scheduling Features</h2>
