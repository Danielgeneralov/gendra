  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-48 px-8 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 border-t border-slate-700">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-5xl font-light tracking-tight text-white text-center mb-12 max-w-3xl mx-auto leading-relaxed animate-[fadeIn_1.2s_ease-in-out] opacity-0 animation-fill-mode-forwards">
            The Complete Factory Operating System
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-800/70 p-8 rounded-xl shadow-md border border-slate-700 transition-all duration-300 hover:bg-slate-800 hover:border-blue-900/50 animate-[fadeIn_1.2s_ease-in-out] opacity-0 animation-fill-mode-forwards animation-delay-300">
              ...
              <h3 className="text-2xl font-light tracking-tight text-white mb-4">Intelligent Quoting</h3>
              <p className="text-slate-300 leading-relaxed">Analyze custom job requirements and generate accurate quotes in minutes with AI that learns from your production data.</p>
            </div>
            
            <div className="bg-slate-800/70 p-8 rounded-xl shadow-md border border-slate-700 transition-all duration-300 hover:bg-slate-800 hover:border-blue-900/50 animate-[fadeIn_1.2s_ease-in-out] opacity-0 animation-fill-mode-forwards animation-delay-600">
              <div className="flex justify-center mb-6">
                <svg className="w-10 h-10 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5m-9-6h.008v.008H12v-.008zM12 15h.008v.008H12V15zm0 2.25h.008v.008H12v-.008zM9.75 15h.008v.008H9.75V15zm0 2.25h.008v.008H9.75v-.008zM7.5 15h.008v.008H7.5V15zm0 2.25h.008v.008H7.5v-.008zm6.75-4.5h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V15zm0 2.25h.008v.008h-.008v-.008zm2.25-4.5h.008v.008H16.5v-.008zm0 2.25h.008v.008H16.5V15z" />
                </svg>
              </div>
              <h3 className="text-2xl font-light tracking-tight text-white mb-4">Dynamic Scheduling</h3>
              <p className="text-slate-300 leading-relaxed">Optimize your shop floor with scheduling that adapts to changing conditions, constraints, and priorities in real-time.</p>
            </div>
            
            <div className="bg-slate-800/70 p-8 rounded-xl shadow-md border border-slate-700 transition-all duration-300 hover:bg-slate-800 hover:border-blue-900/50 animate-[fadeIn_1.2s_ease-in-out] opacity-0 animation-fill-mode-forwards animation-delay-900">
              <div className="flex justify-center mb-6">
                <svg className="w-10 h-10 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" />
                </svg>
              </div>
              <h3 className="text-2xl font-light tracking-tight text-white mb-4">Real-Time Intelligence</h3>
              <p className="text-slate-300 leading-relaxed">Turn your data into actions with continuous monitoring and AI decision support to optimize operations across your facility.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-48 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-900 to-indigo-950 border-t border-slate-700">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-5xl font-light tracking-tight text-white mb-6 max-w-3xl mx-auto animate-[fadeIn_1.2s_ease-in-out] opacity-0 animation-fill-mode-forwards">
            Ready for the Future of Manufacturing?
          </h2>
          <p className="text-lg text-slate-300 mb-10 max-w-2xl mx-auto leading-relaxed animate-[fadeIn_1.2s_ease-in-out] opacity-0 animation-fill-mode-forwards animation-delay-300">
          ...
          <div className="animate-[fadeIn_1.2s_ease-in-out] opacity-0 animation-fill-mode-forwards animation-delay-600">
            <Link 
              href="/quote" 
              className="bg-blue-600 hover:bg-blue-700 transition-colors duration-200 rounded-lg px-8 py-4 text-lg font-medium text-white inline-block hover:shadow-lg border border-blue-500"
            >
              Start with Gendra
            </Link>
          </div>
