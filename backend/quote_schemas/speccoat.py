...
class SpecCoatSchema(QuoteSchemaBase):
    def calculate_quote(self, fields: Dict[str, Any]) -> float:
        ...
        cert_requirements = fields.get("cert_requirements", False)  # Default no certification
        ...
        base_quote = quantity * 6 * complexity * urgency_multiplier * masking_multiplier * size_factor
